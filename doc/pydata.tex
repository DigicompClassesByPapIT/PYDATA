...
voila --TagRemovePreprocessor.remove_cell_tags='{"hide"}' mon_notebook.ipynb
    ...
    \begin{frame}[fragile]{Expressions\textit{lambda}}{Map, filter et reduce}
        ...
        \begin{itemize}
            \item Les fonctions pures, qui ne modifient pas, ni ne dépendent pas de l'état du programme ou de son environnement.
...
df_7965 = df_orders[df_orders["id_store"] == 7965]
        \end{lstlisting}
        \begin{dangercolorbox}
            Appliquer le masque ne modifie le DataFrame, il permet d'en retourner un nouveau qu'il faut assigner à une nouvelle variable.
...
4      Fiat  10000
    ...
    \begin{frame}{Agrégation et regroupement de données}
        ...
        \bigbreak
        Le \lstinline{pandas.DataFrame.groupby} agrège et doit être associé à une fonction comme~:
        \begin{itemize}
