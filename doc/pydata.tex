...
assert len(df_sub_filtered["id_store"].notnull()) == len(df_sub[df_sub_mask])
    ...
    \begin{frame}[fragile]{Combinaison et transformation de données}{Combinaison}
...
Out[45]: numpy.uint16
    ...
    \begin{frame}{Plotly}{Plotly et Plotly Express}
        ...
        \begin{itemize}
            ...
            \item Graphique PNG, SVG, PDF, \textit{etc} à insérer dans un document
            \item L'objet graphique Plotly est un objet Python qui peut directement être affiché dans un notebook Jupyter.
        \end{itemize}
        \bigbreak
        Les images ne sont pas des graphiques interactifs, mais des statiques, concernant le HTML il l'est, grâce à WebGL, le Python l'est également dans IPython.
    ...
    \begin{frame}{Plotly}{Plotly et Plotly Express}
        Quasiment tous les types de graphiques sont gérés, voir \url{https://plotly.com/python/}.
        \bigbreak
...
fig
        ...
        Mais même cette version \textquote{simple} offre ne nombreuses possibilités de personnalisation, voir \url{https://plotly.com/python-api-reference/generated/plotly.express.pie}.
    \end{frame}
...
fig
    ...
    \begin{frame}{Deep Learning (réseau de neuronnes récurrents)}{Exercice \execcounterdispinc{}}
        ...
        \bigbreak
        \centering
        \includegraphics[width=7cm]{image/btc-price-prediction}
    \end{frame}
